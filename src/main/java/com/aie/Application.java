...
public class Application {
    ...
    @Bean
    CommandLineRunner init(SiteRepository siteRepository) {

        return args -> {

            Site obj = siteRepository.findById("123456").orElse(new Site());
            System.out.println(obj);

            Site obj2 = siteRepository.findFirstBySiteName("aienterprise.com");
